...
export async function POST(req) {
  try {
    ...
    ws.columns=[{header:'CÃ³digo',key:'codigo',width:22},{header:'Cantidad comprada',key:'cantidad',width:18},{header:'Costo unitario de la compra',key:'costo',width:28},{header:'Descuento',key:'descuento',width:12}]
