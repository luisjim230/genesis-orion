...
export async function GET(request) {
  ...
  return handle(async () => {
    ...
    let q = db.from('conta_asientos').select(
      '*, factura:conta_facturas(clave,nombre_emisor,cedula_emisor,total_comprobante,estado_hacienda,tipo_documento,clave_referencia), lineas:conta_asiento_lineas(id)'
    )
