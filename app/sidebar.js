...
const ALL_NAV=[
  ...
  {group:'Inventario',items:[{href:'/inventario',key:'inventario',icon:'📦',name:'Compras'},{href:'/trazabilidad',key:'trazabilidad',icon:'🔴',name:'Trazabilidad'},{href:'/kronos',key:'kronos',icon:'📈',name:'Proyección de inventario'},{href:'/pricing',key:'pricing',icon:'💲',name:'Pricing'}]},
