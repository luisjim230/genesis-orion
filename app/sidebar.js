...
const ALL_NAV=[
  ...
  {group:'Gestión',items:[{href:'/finanzas',key:'finanzas',icon:'💰',name:'Finanzas'},{href:'/tareas',key:'tareas',icon:'✅',name:'Tareas'}]},
    ...
    <>
      ...
      <aside style={{width:collapsed?64:240,background:'#5E2733',borderRight:'1px solid rgba(255,255,255,0.06)',position:'fixed',top:0,left:0,height:'100vh',overflowY:'auto',overflowX:'hidden',display:'flex',flexDirection:'column',zIndex:100,transition:'width 0.2s ease'}}>
        <div style={{padding:collapsed?'16px 12px':'18px 20px',borderBottom:'1px solid rgba(255,255,255,0.07)',display:'flex',alignItems:'center',gap:10,flexShrink:0}}>
          ...
          {!collapsed&&<div style={{lineHeight:1}}><div style={{fontFamily:"'Nunito',sans-serif",fontWeight:800,color:'rgba(253,244,244,0.55)',fontSize:6.5,letterSpacing:'0.10em',textTransform:'uppercase',marginBottom:2}}>SISTEMA DE OPERACIONES Y</div><div style={{fontFamily:"'Nunito',sans-serif",fontWeight:900,color:'#ED6E2E',fontSize:19,letterSpacing:'0.02em',lineHeight:1.05}}>LOGÍSTICA</div></div>}
        </div>
