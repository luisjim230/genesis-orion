...
const ALL_NAV=[
  ...
  {group:'Inventario',items:[{href:'/inventario',key:'inventario',icon:'📦',name:'Compras'},{href:'/trazabilidad',key:'trazabilidad',icon:'🔴',name:'Trazabilidad'},{href:'/kronos',key:'kronos',icon:'📈',name:'Proyección de inventario'},{href:'/profecias',key:'profecias',icon:'🔭',name:'Profecías'},{href:'/pricing',key:'pricing',icon:'💲',name:'Pricing'}]},
  {group:'Comercial',items:[{href:'/comercial',key:'comercial',icon:'💼',name:'Ventas · Equipo'},{href:'/comercial/seguimiento-proformas',key:'seguimiento-proformas',icon:'📋',name:'Seguimiento de Proformas'}]},
