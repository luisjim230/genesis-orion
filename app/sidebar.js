...
const ALL_NAV=[
  ...
  {group:'Operaciones',items:[{href:'/cajas-aurora',key:'cajas-aurora',icon:'🌅',name:'Cajas'}]},{group:'Transportes',items:[{href:'/entregas',key:'entregas',icon:'🚛',name:'Entregas · Trazabilidad'}]},{group:'Gestión',items:[{href:'/finanzas',key:'finanzas',icon:'💰',name:'Finanzas'},{href:'/finanzas/bancos',key:'bancos',icon:'🏦',name:'Bancos'},{href:'/tareas',key:'tareas',icon:'✅',name:'Tareas'},{href:'/social',key:'social',icon:'📱',name:'Redes Sociales'}]},
