...
// ── Estilos Liquid Glass Light Mode ────────────────────────────────────────
const GOLD = '#c8a84b';
const S = {
  ...
  tabs:      { display:'flex', gap:'8px', marginBottom:'24px', borderBottom:'1px solid rgba(0,0,0,0.08)' },
  tab:       { padding:'8px 18px', borderRadius:'8px 8px 0 0', border:'none', cursor:'pointer', fontSize:'0.9rem', fontWeight:500, background:'transparent', color:'rgba(0,0,0,0.4)', marginBottom:'-1px', transition:'all 0.2s' },
  tabActive: { background:'rgba(255,255,255,0.5)', color:GOLD, borderBottom:`2px solid ${GOLD}` },
  ...
  input:     { background:'rgba(255,255,255,0.5)', border:'1px solid rgba(0,0,0,0.1)', borderRadius:'8px', color:'rgba(0,0,0,0.8)', padding:'8px 12px', fontSize:'0.9rem', width:'100%', outline:'none', boxSizing:'border-box', backdropFilter:'blur(8px)' },
  select:    { background:'rgba(255,255,255,0.5)', border:'1px solid rgba(0,0,0,0.1)', borderRadius:'8px', color:'rgba(0,0,0,0.8)', padding:'8px 12px', fontSize:'0.9rem', width:'100%', outline:'none', backdropFilter:'blur(8px)' },
  btnPrimary:{ background:`linear-gradient(135deg, ${GOLD}, #a08930)`, color:'#fff', border:'none', borderRadius:'10px', padding:'10px 24px', fontWeight:700, cursor:'pointer', fontSize:'0.95rem', boxShadow:`0 4px 20px rgba(200,168,75,0.25)`, transition:'all 0.2s' },
  btnGhost:  { background:'rgba(255,255,255,0.45)', color:'rgba(0,0,0,0.7)', border:'1px solid rgba(0,0,0,0.1)', borderRadius:'10px', padding:'8px 16px', cursor:'pointer', fontSize:'0.88rem', backdropFilter:'blur(12px)', transition:'all 0.2s' },
  btnDanger: { background:'rgba(239,68,68,0.08)', color:'#dc2626', border:'1px solid rgba(239,68,68,0.2)', borderRadius:'10px', padding:'8px 16px', cursor:'pointer', fontSize:'0.88rem', backdropFilter:'blur(12px)', transition:'all 0.2s' },
  btnEdit:   { background:'rgba(37,99,235,0.08)', color:'#2563eb', border:'1px solid rgba(37,99,235,0.2)', borderRadius:'10px', padding:'6px 12px', cursor:'pointer', fontSize:'0.82rem', fontWeight:600, backdropFilter:'blur(12px)', transition:'all 0.2s' },
  label:     { fontSize:'0.82rem', color:'rgba(0,0,0,0.45)', marginBottom:'4px', display:'block' },
  divider:   { border:'none', borderTop:'1px solid rgba(0,0,0,0.06)', margin:'20px 0' },
  info:      { background:'rgba(59,130,246,0.08)', border:'1px solid rgba(59,130,246,0.2)', borderRadius:'12px', padding:'12px 16px', color:'#1d4ed8', fontSize:'0.88rem', marginBottom:'12px', backdropFilter:'blur(12px)' },
  success:   { background:'rgba(34,197,94,0.08)', border:'1px solid rgba(34,197,94,0.2)', borderRadius:'12px', padding:'10px 14px', color:'#15803d', fontSize:'0.88rem', marginBottom:'12px', backdropFilter:'blur(12px)' },
  warning:   { background:'rgba(234,179,8,0.08)', border:'1px solid rgba(234,179,8,0.2)', borderRadius:'12px', padding:'10px 14px', color:'#a16207', fontSize:'0.88rem', marginBottom:'12px', backdropFilter:'blur(12px)' },
  error:     { background:'rgba(239,68,68,0.08)', border:'1px solid rgba(239,68,68,0.2)', borderRadius:'12px', padding:'10px 14px', color:'#dc2626', fontSize:'0.88rem', marginBottom:'12px', backdropFilter:'blur(12px)' },
  table:     { width:'100%', borderCollapse:'collapse', fontSize:'0.82rem' },
  th:        { background:'rgba(255,255,255,0.35)', color:'rgba(0,0,0,0.5)', padding:'8px 10px', textAlign:'left', borderBottom:'1px solid rgba(0,0,0,0.08)', fontWeight:600, whiteSpace:'nowrap' },
  td:        { padding:'7px 10px', borderBottom:'1px solid rgba(0,0,0,0.06)', color:'rgba(0,0,0,0.75)' },
  metric:    { background:'rgba(255,255,255,0.4)', backdropFilter:'blur(12px)', WebkitBackdropFilter:'blur(12px)', borderRadius:14, padding:'14px 18px', border:'1px solid rgba(255,255,255,0.5)', textAlign:'center', boxShadow:'0 2px 12px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.7)' },
  metricVal: { fontSize:'1.3rem', fontWeight:700, color:GOLD },
  metricLbl: { fontSize:'0.78rem', color:'rgba(0,0,0,0.4)', marginTop:'4px' },
