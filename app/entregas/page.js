...
const s = {
  page: { background:'transparent', minHeight:'100vh', color:'rgba(0,0,0,0.8)', fontFamily:'sans-serif', padding:'0 0 40px' },
  ...
  sel: { background:'rgba(255,255,255,0.5)', border:'1px solid rgba(0,0,0,0.1)', color:'rgba(0,0,0,0.8)', padding:'7px 10px', borderRadius:8, fontSize:13, outline:'none' },
  btnPrimary: { background:'linear-gradient(135deg, #c8a84b, #a08930)', color:'#fff', border:'none', borderRadius:10, padding:'8px 18px', fontSize:13, fontWeight:700, cursor:'pointer', boxShadow:'0 4px 20px rgba(200,168,75,0.25)' },
  btnSecondary: { background:'rgba(255,255,255,0.4)', color:'rgba(0,0,0,0.6)', border:'1px solid rgba(0,0,0,0.1)', borderRadius:10, padding:'8px 16px', fontSize:13, cursor:'pointer' },
  ...
  sumCard: { background:'rgba(255,255,255,0.4)', backdropFilter:'blur(12px)', border:'1px solid rgba(255,255,255,0.5)', borderRadius:14, padding:'12px 16px', minWidth:130, boxShadow:'0 2px 12px rgba(0,0,0,0.04)' },
  ...
  busq: { width:'100%', background:'rgba(255,255,255,0.5)', border:'1px solid rgba(0,0,0,0.1)', borderRadius:9, color:'rgba(0,0,0,0.8)', padding:'9px 14px', fontSize:13, outline:'none', marginBottom:10, boxSizing:'border-box', backdropFilter:'blur(8px)' },
  estadoFiltros: { display:'flex', gap:8, flexWrap:'wrap' },
  fBtn: { background:'rgba(255,255,255,0.3)', border:'1px solid rgba(0,0,0,0.08)', color:'rgba(0,0,0,0.45)', borderRadius:20, padding:'5px 14px', fontSize:11, cursor:'pointer' },
  fBtnActive: { background:'rgba(200,168,75,0.12)', borderColor:'#c8a84b', color:'#c8a84b' },
  ...
  card: { background:'rgba(255,255,255,0.55)', backdropFilter:'blur(24px) saturate(1.8)', WebkitBackdropFilter:'blur(24px) saturate(1.8)', border:'1px solid rgba(255,255,255,0.6)', borderRadius:20, marginBottom:9, overflow:'hidden', boxShadow:'0 4px 30px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.8)' },
  ...
  cardFecha: { fontSize:12, color:'rgba(0,0,0,0.4)', minWidth:36, textAlign:'center', lineHeight:1.3 },
  cardCliente: { fontSize:14, fontWeight:600, color:'rgba(0,0,0,0.85)' },
  ...
  lugarText: { fontSize:11, color:'rgba(0,0,0,0.45)' },
  choferText: { fontSize:11, color:'rgba(0,0,0,0.45)' },
  ...
  factuBadge: { fontSize:11, color:'rgba(0,0,0,0.4)' },
  expandIcon: { fontSize:10, color:'rgba(0,0,0,0.35)' },
  cardDetail: { borderTop:'1px solid rgba(0,0,0,0.06)', padding:'14px 16px' },
  ...
  detLabel: { fontSize:10, color:'rgba(0,0,0,0.4)', letterSpacing:0.5 },
  detVal: { fontSize:13, fontWeight:600, color:'rgba(0,0,0,0.85)' },
  detObs: { fontSize:12, color:'rgba(0,0,0,0.5)', background:'rgba(255,255,255,0.3)', borderRadius:7, padding:'8px 10px', marginBottom:10, lineHeight:1.5 },
  ...
  sectionTitle: { fontSize:11, color:'rgba(0,0,0,0.35)', textTransform:'uppercase', letterSpacing:1, marginBottom:12, marginTop:8 },
