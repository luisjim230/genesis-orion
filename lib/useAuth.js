...
const PERMISOS_ROL = {
  ...
  admin:     ['dashboard','inventario','trazabilidad','rotacion','kronos','profecias','pricing','reportes','comercial','seguimiento-proformas','cif','contenedores','aduana','mercado','radar','campanas','metricas-web','finanzas','tareas','tareas-equipo','ponderacion','social','admin',"cajas-aurora","entregas","pagos"],
  bodega:    ['dashboard','inventario','trazabilidad','rotacion','kronos','profecias','contenedores',"entregas"],
  ventas:    ['dashboard','trazabilidad','comercial','seguimiento-proformas','reportes',"entregas"],
  finanzas:  ['dashboard','contenedores','aduana','mercado','ponderacion','finanzas','tareas-equipo',"cajas-aurora","entregas"],
