...
const PERMISOS_ROL = {
  ...
  admin:     ['dashboard','inventario','trazabilidad','rotacion','kronos','reportes','comercial','cif','contenedores','mercado','finanzas','tareas','ponderacion','social','admin',"cajas-aurora","entregas","pagos"],
