...
const PERMISOS_ROL = {
  ...
  admin:     ['dashboard','inventario','trazabilidad','rotacion','kronos','reportes','comercial','seguimiento-proformas','cif','contenedores','aduana','mercado','radar','campanas','metricas-web','finanzas','tareas','tareas-equipo','ponderacion','social','admin',"cajas-aurora","entregas","pagos"],
