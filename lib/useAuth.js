...
const PERMISOS_ROL = {
  ...
  admin:     ['dashboard','inventario','trazabilidad','rotacion','kronos','reportes','comercial','cif','contenedores','mercado','finanzas','tareas','ponderacion','social','admin',"cajas-aurora","entregas"],
  ...
  finanzas:  ['dashboard','contenedores','mercado','ponderacion','finanzas',"cajas-aurora","entregas"],
  logistica: ['dashboard','contenedores','cif','mercado','reportes'],
  vendedor: ['dashboard','entregas'],
};
